...
echo "  GITHUB_OAUTH_CLIENT_ID    GitHub OAuth App Client ID"
echo "  GITHUB_OAUTH_CLIENT_SECRET GitHub OAuth App Client Secret"
echo ""
echo "==> 推荐部署顺序"
...
echo "  5. 将 GITHUB_OAUTH_* 写入 GitHub Secrets，再次运行 workflow"
