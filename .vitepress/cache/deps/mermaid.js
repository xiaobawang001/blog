...
import {
  JSON_SCHEMA,
  load
} from "./chunk-AHFRPEJ7.js";
import {
  registerLayoutLoaders
} from "./chunk-6FXY2TJ2.js";
import "./chunk-YJJUDPN4.js";
import "./chunk-4W7MLASG.js";
import "./chunk-GB36WENI.js";
import "./chunk-4PVLT3VJ.js";
import "./chunk-V37S4GAJ.js";
import "./chunk-BI5ZWNSQ.js";
import {
  dedent
} from "./chunk-MJORFFQT.js";
import {
  registerIconPacks
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-LMCZKHZV-CU5B5B2W.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-23GEKE2U-VHFX2Y5U.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./swimlanesDiagram-G3AALYLV-2GAVBEQC.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q63AITRT-SNCTDORR.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-IHSO6WYX-2NR3TCGK.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-NO4QXBWP-TEB7XHTL.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-FWYZ7A6U-4JMI6JC2.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ENE6RG2P-6ETNDWU7.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-ABIIQ3AL-XM6JCYQV.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-FW5EYKEG-GHXFAUKC.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-TGXJPOKE-UGPPSSRM.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-DBY2YBRQ-EU6X3KKD.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-OUVF2IWQ-KCICTBZL.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-EOCWNBFH-IXV6L3O3.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-2N3HPSRC-WW2L253T.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-6OUMAXLB-7UDO7QMX.js");
...
var loader18 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-5HDEW3XC-TGKEAJP7.js");
...
var draw = __name((_text, id39, version) => {
...
var detector19 = __name((txt, config = {}) => {
  var _a2;
  if (
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-FHXFAJF6-N3U2M7BG.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-LN4V7U3C-4R6QEVEC.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-HUTT4EX6-G6ESMK2X.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-HTMAVEWB-EGZNDFRE.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-NH7WQ7WH-YVCKGOQW.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-WEI45ONY-HURXLZY3.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-677ZJIJ3-AA7CKSCC.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OA4YK3LP-JCSYTMK6.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-ZJ3FMSHR-BP4YTDHA.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-FQU43EPY-4A53ZCIA.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-FXEZZL3T-3DBTPWTT.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-L72KCM5P-5CL5UCHD.js");
...
var id32 = "treemap";
var detector32 = __name((txt) => {
  return /^\s*treemap/.test(txt);
}, "detector");
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-G47NLZAW-XGBCAUSM.js");
...
var id33 = "wardley";
var detector33 = __name((text) => {
  return /^\s*wardley-beta/i.test(text);
}, "detector");
var loader33 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-EHGQE667-JLCLOVO5.js");
...
var loader34 = __name(async () => {
  const { diagram: diagram2 } = await import("./cynefinDiagram-TSTJHNR4-JQZSQICU.js");
...
var loader35 = __name(async () => {
  const { diagram: diagram2 } = await import("./railroadDiagram-RFXS5EU6-5SH2O4VB.js");
...
var loader36 = __name(async () => {
  const { diagram: diagram2 } = await import("./ebnfDiagram-CCIWWBDH-CTJMADTK.js");
...
var loader37 = __name(async () => {
  const { diagram: diagram2 } = await import("./abnfDiagram-VRR7QNED-TNXPKYPW.js");
...
var detector38 = __name((txt) => {
  return /^\s*railroad-peg-beta/i.test(txt);
}, "detector");
var loader38 = __name(async () => {
  const { diagram: diagram2 } = await import("./pegDiagram-2B236MQR-7G2N76CC.js");
...
var appendDivSvgG = __name((parentRoot, id39, enclosingDivId, divStyle, svgXlink) => {
...
var removeExistingElements = __name((doc, id39, divId, iFrameId) => {
  var _a2, _b, _c;
  (_a2 = doc.getElementById(id39)) == null ? void 0 : _a2.remove();
  (_b = doc.getElementById(divId)) == null ? void 0 : _b.remove();
  (_c = doc.getElementById(iFrameId)) == null ? void 0 : _c.remove();
}, "removeExistingElements");
var render = __name(async function(id39, text, svgContainingElement) {
...
var render2 = __name((id39, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = __name(() => new Promise((res, rej) => {
