...
var Theme = (_a = class {
  ...
  updateColors() {
    var _a14, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W;
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-2IZCJRC5.js");
...
*/
//# sourceMappingURL=chunk-DLGGCRHX.js.map
